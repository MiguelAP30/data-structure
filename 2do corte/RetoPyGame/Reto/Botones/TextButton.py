...
class TextButton(Button):
    ...
    def __init__(self, text, font_size, coords):
        ...
        self.text = text
        self.text_render = self.font.render(self.text,True,(38,238,238))#(250,250,250))
    ...
    def draw(self, screen, mouse_position):
        if self.is_mouse_contained(mouse_position):
            ...
            border_width = 3
        pygame.draw.rect(screen,(150,150,150), pygame.Rect(self.x, self.y, self.width, self.height), border_width) # type: ignore
