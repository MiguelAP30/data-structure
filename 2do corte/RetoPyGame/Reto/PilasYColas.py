...
class Pilas:
    def __init__(self):
        ...
        self.persona1= pygame.image.load("C:/Users/migue/OneDrive/Documentos/UAM/SEMESTRE #3/TAD/1sem tad/2do corte/RetoPyGame/Reto/tanjiro.png")
        self.persona1= pygame.transform.scale(self.persona1,(680,680))
        self.persona2= pygame.image.load("C:/Users/migue/OneDrive/Documentos/UAM/SEMESTRE #3/TAD/1sem tad/2do corte/RetoPyGame/Reto/naruto.png")
        self.persona2= pygame.transform.scale(self.persona2,(500,500))
        self.persona3= pygame.image.load("C:/Users/migue/OneDrive/Documentos/UAM/SEMESTRE #3/TAD/1sem tad/2do corte/RetoPyGame/Reto/eren.png")
        self.persona3= pygame.transform.scale(self.persona3,(600,984))
        self.fondo= pygame.image.load("C:/Users/migue/OneDrive/Documentos/UAM/SEMESTRE #3/TAD/1sem tad/2do corte/RetoPyGame/Reto/fondoblackjack2.jpg")
        self.fondo= pygame.transform.scale(self.fondo,(1100,700))
        self.crupier= pygame.image.load("C:/Users/migue/OneDrive/Documentos/UAM/SEMESTRE #3/TAD/1sem tad/2do corte/RetoPyGame/Reto/baraja3.jpg")
        self.crupier=pygame.transform.scale(self.crupier,(1200,600))
        self.cartaas=pygame.image.load("C:/Users/migue/OneDrive/Documentos/UAM/SEMESTRE #3/TAD/1sem tad/2do corte/RetoPyGame/Reto/as.jpg")
        self.cartaas=pygame.transform.scale(self.cartaas,(120,120))
        self.carta2=pygame.image.load("C:/Users/migue/OneDrive/Documentos/UAM/SEMESTRE #3/TAD/1sem tad/2do corte/RetoPyGame/Reto/carta2.jpg")
        self.carta2=pygame.transform.scale(self.carta2,(120,120))
        self.carta3=pygame.image.load("C:/Users/migue/OneDrive/Documentos/UAM/SEMESTRE #3/TAD/1sem tad/2do corte/RetoPyGame/Reto/carta3.jpg")
        self.carta3=pygame.transform.scale(self.carta3,(120,120))
        self.carta4=pygame.image.load("C:/Users/migue/OneDrive/Documentos/UAM/SEMESTRE #3/TAD/1sem tad/2do corte/RetoPyGame/Reto/carta4.jpg")
        self.carta4=pygame.transform.scale(self.carta4,(120,120))
        self.carta5=pygame.image.load("C:/Users/migue/OneDrive/Documentos/UAM/SEMESTRE #3/TAD/1sem tad/2do corte/RetoPyGame/Reto/carta5.jpg")
        self.carta5=pygame.transform.scale(self.carta5,(120,120))
        self.carta6=pygame.image.load("C:/Users/migue/OneDrive/Documentos/UAM/SEMESTRE #3/TAD/1sem tad/2do corte/RetoPyGame/Reto/carta6.jpg")
        self.carta6=pygame.transform.scale(self.carta6,(120,120))
        self.carta7=pygame.image.load("C:/Users/migue/OneDrive/Documentos/UAM/SEMESTRE #3/TAD/1sem tad/2do corte/RetoPyGame/Reto/carta7.jpg")
        self.carta7=pygame.transform.scale(self.carta7,(120,120))
        self.carta8=pygame.image.load("C:/Users/migue/OneDrive/Documentos/UAM/SEMESTRE #3/TAD/1sem tad/2do corte/RetoPyGame/Reto/carta8.jpg")
        self.carta8=pygame.transform.scale(self.carta8,(120,120))
        self.carta9=pygame.image.load("C:/Users/migue/OneDrive/Documentos/UAM/SEMESTRE #3/TAD/1sem tad/2do corte/RetoPyGame/Reto/carta9.jpg")
        self.carta9=pygame.transform.scale(self.carta9,(120,120))
        self.carta10=pygame.image.load("C:/Users/migue/OneDrive/Documentos/UAM/SEMESTRE #3/TAD/1sem tad/2do corte/RetoPyGame/Reto/carta10.jpg")
        self.carta10=pygame.transform.scale(self.carta10,(120,120))
        self.j=pygame.image.load("C:/Users/migue/OneDrive/Documentos/UAM/SEMESTRE #3/TAD/1sem tad/2do corte/RetoPyGame/Reto/j.jpg")
        self.j=pygame.transform.scale(self.j,(120,120))
        self.q=pygame.image.load("C:/Users/migue/OneDrive/Documentos/UAM/SEMESTRE #3/TAD/1sem tad/2do corte/RetoPyGame/Reto/q.jpg")
        self.q=pygame.transform.scale(self.q,(120,120))
        self.k=pygame.image.load("C:/Users/migue/OneDrive/Documentos/UAM/SEMESTRE #3/TAD/1sem tad/2do corte/RetoPyGame/Reto/k.jpg")
        self.k=pygame.transform.scale(self.k,(120,120))
        self.alrevez=pygame.image.load("C:/Users/migue/OneDrive/Documentos/UAM/SEMESTRE #3/TAD/1sem tad/2do corte/RetoPyGame/Reto/alrevez.jpg")
        self.alrevez=pygame.transform.scale(self.alrevez,(120,120))
        self.flecha= pygame.image.load("C:/Users/migue/OneDrive/Documentos/UAM/SEMESTRE #3/TAD/1sem tad/2do corte/RetoPyGame/Reto/flecha.png")
